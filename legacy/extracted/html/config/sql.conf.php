...
$blog_arianetitle="Blog automobile";
    ...
    $constructeurs = "auto";
    $constructeurs_title = "Constructeurs automobile";
    $guide = "guide";
    $guide_title = "Guide d'achat";
    $word = "words";
    $word_title = "Achat de pièces de voiture en ligne";
$mySpace = "mon-compte";
$Piece = "pieces";
$Auto = "constructeurs";
...
function content_cleaner($string)
{
    ...
    $string = str_replace("  ", " ", $string);
    $string = str_replace("..", ".", $string);
    $string = str_replace("/constructeurs.html", "", $string);
    $string = str_replace("/equipementiers.html", "", $string);
    return $string;
}
?>
<?php
